...
//   // Convert [x1,y1,x2,y2] doubles -> pixel ints (use given imgW/imgH!)
...
//     // rectangle (API is positional: x1,y1,x2,y2,color)
//     _drawThickRect(im, x1: x1, y1: y1, x2: x2 - 1, y2: y2 - 1, color: col, thickness: 25);
...
//     img.drawString(im, img.arial_14, x1 + 4, top + 3, text, color: img.getColor(255, 255, 255));
//   }

//   final out = File('${Directory.systemTemp.path}/annotated_${DateTime.now().millisecondsSinceEpoch}.png');
//   await out.writeAsBytes(img.encodePng(im), flush: true);
//   return out;
// }
